...
async function init() {
  ...
  if (mac) {
    ...
    await execute(`./linux/get-docker.sh`)
    await execute(`./linux/get-docker-compose.sh`)
  } else {
    console.error(
      "Unknown - please look online for information about installing docker for our OS."
    )
  }
